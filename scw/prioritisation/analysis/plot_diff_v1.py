#!/usr/bin/env python3
'''
A script to plot the some differences between the simulator output (jobcomp.log)
and the original data coming from sacct (sacct_output.csv).
See code to understand what is plotted.
'''
import numpy as np
import pandas as pd
