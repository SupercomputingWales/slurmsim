...
job_trace <- read.csv(file="/home/slurm/slurm_sim_ws/slurm_sim_tools/scw/test_trace.csv")

# reads in log file of resulting data (what jobs were assigned, where, etc)
sacct_base <- read_sacct_out("/home/slurm/slurm_sim_ws/sim/scw/baseline/results/jobcomp.log")
